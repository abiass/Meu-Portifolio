      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6">
        ...
        >
          <motion.h2
            ...
            className="text-5xl font-bold mb-5 text-center bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400"
          >
            Entre em Contato
          </motion.h2>
          ...
          <motion.p
            variants={itemVariants}
            className="text-center text-zinc-600 dark:text-zinc-400 mb-14 text-lg leading-relaxed"
          >
            Vamos conversar sobre projetos, oportunidades ou qualquer coisa
            interessante!
          </motion.p>
